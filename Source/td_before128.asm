...
ec1		xor a
		...
		push hl
		ex de,hl
		ld de,#40	; add wait time for next enemy
		add hl,de
		ex de,hl
		pop hl
		ld a,r		; type
...
mouse_store_adr ld de,mouse_screen
		push bc
		ld b,10
msa1		ld a,(hl)
		ld (de),a
...
mouse_spr	include "mouse_spr.asm"
mouse_screen	ds 20
...
tower_gfx	include "tower2.asm"
		include "tower.asm"

scr_adr	ds 16*12*2

font 	incbin "rex_font.mem"

back_sprites 		ds 64*16						;!!!
sprbuffer	ds 4*16

en_sprite_right	include "rex_spr_right.asm"
en_spr_rgt_mask	include "rex_spr_right_mask.asm"
en_sprite_left	include "rex_spr_left.asm"
en_spr_lft_mask	include "rex_spr_left_mask.asm"
en_sprite_dwn	include "rex_spr_down.asm"
en_spr_dwn_mask	include "rex_spr_down_mask.asm"
en_sprite_up	include "rex_spr_down.asm"
en_spr_up_mask	include "rex_spr_down_mask.asm"

en2_sprite_right	include "enemy_bike_right.asm"
en2_spr_rgt_mask	include "enemy_bike_right_mask.asm"
en2_sprite_left		include "enemy_bike_left.asm"
en2_spr_lft_mask	include "enemy_bike_left_mask.asm"
en2_sprite_dwn		include "enemy_bike_down.asm"
en2_spr_dwn_mask	include "enemy_bike_down_mask.asm"
en2_sprite_up		include "enemy_bike_down.asm"
en2_spr_up_mask		include "enemy_bike_down_mask.asm"

en_fired	include "enemy_fired.asm"
en_fired_mask	include "enemy_fired_mask.asm"
