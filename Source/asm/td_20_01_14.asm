...
mpr0		cp c
		...
		ld a,(hl)
		cp #ff
		jp nz,rmb2		; #ff - можно ставить башни, else exit
...
mouse_screen	ds #14
enemy_gfx	dw enemy_sprite1,enemy_sprite2,enemy_sprite3	
enemy_pages 	db 1,1,1
