...
intro_text1_adr		equ #40d0
intro_text2_adr		equ #4810
...
intro_screen 	inchob "spr/in.$C"
	org #e600
;	inchob "DEATHWAY.$M.$c"
	inchob "bin/CptDREXX.$c"


		page 1
		org #c000
enemy_sprite1	incbin "bin/_javi_soldier.bin"
enemy_sprite2	incbin "bin/_javi_tank.bin"
